...
profiles from a user’s list of microbes. We introduce mTaxSi, which empowers users to explore 
predicted metabolic functions derived from taxonomic microbial signatures. 
